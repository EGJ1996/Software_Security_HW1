...
int main(int argc, char *argv[]) {
  ...
  unsigned new_height = (unsigned)(round(img->size_y * factor));
  unsigned new_width = (unsigned)(round(img->size_x * factor));
  ...
  if ((UINT_MAX / new_width) / new_height <= sizeof(struct pixel) ||
